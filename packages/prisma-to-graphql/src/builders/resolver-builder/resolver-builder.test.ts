    ...
    itCases(buildResolverFunctionSignature, [
        {
            ...
            expect: 'async function Mutation_myResolver(parentValue: unknown, graphqlArgs: unknown, context: any, resolveInfo: GraphQLResolveInfo) {',
        },
    ]);
});
...
describe(buildResolverBlock.name, () => {
    itCases(buildResolverBlock, [
        ...
        },
        {
            ...
            expect: {
                resolver:
                    "async function Query_MyResolver(parentValue: unknown, graphqlArgs: unknown, context: any, resolveInfo: GraphQLResolveInfo) {\n    return await runPrismaResolver(context, 'User', graphqlArgs, resolveInfo);\n}",
                operationType: 'Query',
            },
        },
        {
            ...
            expect: {
                resolver:
                    'async function Mutation_MyResolver2(parentValue: unknown, graphqlArgs: unknown, context: any, resolveInfo: GraphQLResolveInfo) {}',
                operationType: 'Mutation',
            },
        },
        {
