...
declare function Query_Companies(parentValue: unknown, graphqlArgs: unknown, context: {
    prismaClient: unknown;
}, resolveInfo: GraphQLResolveInfo): Promise<import("@prisma-to-graphql/prisma-resolver").PrismaResolverOutput>;
declare function Mutation_Companies(parentValue: unknown, graphqlArgs: unknown, context: {
    prismaClient: unknown;
}, resolveInfo: GraphQLResolveInfo): Promise<import("@prisma-to-graphql/prisma-resolver").PrismaResolverOutput>;
