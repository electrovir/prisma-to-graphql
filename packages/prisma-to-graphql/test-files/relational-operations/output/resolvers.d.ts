...
declare function Query_UserSettings(parentValue: unknown, graphqlArgs: unknown, context: {
    prismaClient: unknown;
}, resolveInfo: GraphQLResolveInfo): Promise<import("@prisma-to-graphql/prisma-resolver").PrismaResolverOutput>;
declare function Mutation_UserSettings(parentValue: unknown, graphqlArgs: unknown, context: {
    prismaClient: unknown;
}, resolveInfo: GraphQLResolveInfo): Promise<import("@prisma-to-graphql/prisma-resolver").PrismaResolverOutput>;
