...
async function Query_UserSettings(parentValue: unknown, graphqlArgs: unknown, context: any, resolveInfo: GraphQLResolveInfo) {
    return await runPrismaResolver(context, 'UserSettings', graphqlArgs, resolveInfo);
}

async function Mutation_UserSettings(parentValue: unknown, graphqlArgs: unknown, context: any, resolveInfo: GraphQLResolveInfo) {
    return await runPrismaResolver(context, 'UserSettings', graphqlArgs, resolveInfo);
}
